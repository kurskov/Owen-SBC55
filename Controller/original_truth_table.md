...
|      X3      | TEMPERATURE OK STORAGE TANK 1 (WASH)                  | S003 (2 - 1)                        | SW NC     | Термореле. Срабатывает при достижении отмывочной жидкостью нужной температуры.                                                            |
|      X4      | TEMPERATURE OK STORAGE TANK 2 (RINSE)                 | S004 (2 - 1)                        | SW NC     | Термореле. Срабатывает при достижении водой для ополаскивания нужной температуры.                                                         |
|      X5      | DRAIN VALVE OPEN TO STORAGE TANK 1 (WASH)             | S005 (BK - BN)                      | SW NO     | Индуктивный датчик. Срабатывает при открытом положении заслонки слива из рабочей камеры в бак с отмывочной жидкостью.                     |
|      X6      | DRAIN VALVE OPEN TO STORAGE TANK 2 (RINSE)            | S006 (BK - BN)                      | SW NO     | Индуктивный датчик. Срабатывает при открытом положении заслонки слива из рабочей камеры в бак с водой для ополаскивания.                  |
|      X7      | EMERGENCY STOP OK                                     | K101 (2 - 1)                        | SW NO     | Реле. Пока замкнуто, на вход подается высокий уровень.                                                                                    |
|     X10      | LEVEL OK (storage tank 1 wash)                        | S010 (WH - WH)                      | SW NO     | Поплавок. Расположен в нижней части бака с отмывочной жидкостью, при падении размыкает контакт.                                           |
|     X11      | OVERFILLING (storage tank 1 wash)                     | S011 (WH - WH)                      | SW NC     | Поплавок. Расположен в верхней части бака с отмывочной жидкостью, при всплытии размыкает контакт.                                         |
|     X12      | LEVEL OK (storage tank 2 rinse)                       | S012 (WH - WH)                      | SW NO     | Поплавок. Расположен в нижней части бака с водой для ополаскивания, при падении размыкает контакт.                                        |
|     X13      | OVERFILLING (storage tank 2 rinse)                    | S013 (WH - WH)                      | SW NC     | Поплавок. Расположен в верхней части бака с водой для ополаскивания, при всплытии размыкает контакт.                                      |
|     X14      | DRIP TRAY ALARM                                       | S014 (NC)                           | SW NC     | Емкостной датчик. Приобнарудении протечки (сильного повышения уровня жидкости в поддоне установки) размыкает контакт.                     |
|     X15      | AGITATING AT UP POSITION                              | S015 (BK - BN)                      | SW NO     | Индуктивный датчик. Срабатывает при поднятии распылительной трубки в крайнее верхнее положение.                                           |
|     X16      | AGITATING AT DOWN POSITION (HOME)                     | S016 (BK - BN)                      | SW NO     | Индуктивный датчик. Срабатывает при опускании распылительной трубки в крайнее нижнее положение. Эта позиция считается базовой.            |
|     X17      | SAFETY DOOR OK                                        | S017.2 (22 - 21) - S017.1 (22 - 21) | SW NO     | Группа ключей и электромагнитного реле. При закрытых дверях и подачи питания на реле в замке правой створки двери (Y17), цепь замыкается. |
