...
|     X21      | SPRAY PUMP STORAGE TANK 2 (RINSE) (motor alarms)      | F11 (32 - 31)                       | NC        | Автоматический выключатель с термомагнитным расцепителем. Защита от перегрузки и КЗ помпы подачи воды для ополаскивания.                  |
